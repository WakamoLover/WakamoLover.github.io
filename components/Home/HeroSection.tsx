...
const HeroCarousel: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[260px] md:h-[320px] overflow-hidden mb-0 bg-[#070A10] group no-invert">
          ...
          >
            ...
            >
              <img 
                ...
                onError={(e) => {
                  (e.target as HTMLImageElement).src = 'https://placehold.co/1200x700?text=Image+Not+Found';
                }}
              />
